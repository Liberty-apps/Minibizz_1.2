/*
  # Schéma initial MiniBizz - Gestion Auto-Entrepreneur
  ...
  3. Fonctionnalités
    ...
    - Suivi client et planning
    - Calculs automatiques (TVA, charges sociales)
