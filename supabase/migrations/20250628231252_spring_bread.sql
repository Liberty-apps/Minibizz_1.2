/*
  # Schema update for subscription and site management features

  1. New Tables
    - `plans` - Subscription plans with pricing and features
    - `abonnements` - User subscriptions
    - `sites_vitrines` - User showcase websites
    - `templates_sites` - Website templates
    - `limites_utilisation` - Usage tracking per user
  ...
  2. Security
    ...
    - Public read access for plans and templates

  3. Functions
    - Usage limit checking and incrementing
