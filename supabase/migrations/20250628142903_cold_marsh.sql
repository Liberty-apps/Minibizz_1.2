/*
  # Modèle économique MiniBizz - Plans et abonnements

  1. Nouvelles Tables
    - `plans` : Plans tarifaires disponibles
    - `abonnements` : Abonnements utilisateurs
    - `sites_vitrines` : Mini-sites créés par les utilisateurs
    - `templates_sites` : Templates de sites disponibles
    - `limites_utilisation` : Suivi des limites par plan
