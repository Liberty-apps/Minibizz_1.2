/*
  ...
  1. New Data
    - Insert subscription plans into the `plans` table
    - Add "Premium + Pack Pro" and other essential plans
    - Configure pricing, features, and limits for each plan

  2. Plans Structure
    - Basic plan (free tier)
    - Premium plan 
    - Premium + Pack Pro plan (the missing one causing the error)
    - Each plan includes pricing, features, and usage limits
*/
